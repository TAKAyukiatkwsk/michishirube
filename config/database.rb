...
database_name = case Padrino.env
  when :development then 'michishirube_development'
  when :production  then 'michishirube_production'
  when :test        then 'michishirube_test'
end
...
#     sessions:
#       default:
#         database: michishirube_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: michishirube_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: michishirube_test
#         hosts:
#           - localhost:27017
#
#
